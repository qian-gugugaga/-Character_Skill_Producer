...
| 4 关系  | Wiki人际关系、剧情分析、**跨作品互动（如适用）**             | 对每个重要人物的态度与行为差异、社会认知模式、关系演变、**与其他团/作品的交叉关系** | `04-relationships.md` |
| 5 名场面 | 关键剧情、转折点、争议场景、**跨作品关键场景（如适用）**           | 关键时刻的决策逻辑、压力下的行为、角色高光与低谷                     | `05-key-scenes.md`    |
