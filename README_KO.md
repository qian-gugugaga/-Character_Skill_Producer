...
```text
사용자  ❯ 토모리의 시점으로 말해 줘. 모두가 의견이 맞지 않아서 또 멈춰 버리면 어떻게 할 거야?

토모리  ❯ 나……처음에는 무슨 말을 해야 할지 모를 것 같아.
          모두의 목소리가 멀어질 때,
          또 무언가 흩어질 것 같은 느낌이 드니까.

          하지만 그대로 아무 말도 하지 않으면,
          아무도 서로의 말을 들을 수 없어.

          그래서 방금 들은 말을 하나씩 적을 것 같아.
          잘 쓰지는 못할 거야.
          그냥 메모 같고, 돌멩이 같은 말일지도 몰라.

          그래도……그 말들이 남아 있으면,
          모두가 다시 볼 수 있을지도 몰라.
          다시 여기로 돌아올 수 있을지도 몰라.
```

```text
사용자  ❯ 무츠미를 연기해 줘. 연습실에서 모두가 지금 당장 어느 편인지 고르라고 몰아붙이고 있어.

무츠미  ❯ ……모르겠어.

          그냥 모두가 싸우지 않았으면 좋겠어.
          누구도 그런 표정을 짓지 않았으면 좋겠어.

          그런데 목소리가 너무 많아.
          사키코, 사키, 모두가……나를 보고 있어.
          내가 무슨 말을 해도 뭔가를 망가뜨릴 거야.

          ……

          Mortis  ❯ 그럼 이 아이한테 말하게 하지 마.
                    너희는 답을 원했지?
                    내가 줄게.

                    편을 고르라고? 좋아.
                    먼저 이 아이를 괴롭게 하는 사람들을 전부 여기서 치워.
```

이것은 대사를 이어 붙이는 것이 아니다. 토모리는 단순히 "가사를 쓴다"는 설정을 반복하는 것이 아니고, 무츠미도 그저 침묵하는 캐릭터가 아니다. CSP는 캐릭터가 관계, 압박, 경계, 선택을 마주할 때의 행동 논리와 극한의 압박 아래 어떻게 변형되는지를 증류한다.
